 ...
 * @since 1.0.0
 */
public class BookingVehicleUpcomingListAdapter extends BaseAdapter {
	...
	public BookingVehicleUpcomingListAdapter(Context context) {
        super();
//        this.mInflater = LayoutInflater.from(context);
	...
	public BookingVehicleUpcomingListAdapter(Context context, List<ObmBookingVehicleItem> items) {
        super();
//        this.mInflater = LayoutInflater.from(context);
        mContext = context;
        mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
