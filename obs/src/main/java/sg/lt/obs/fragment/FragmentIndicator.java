...
public class FragmentIndicator extends LinearLayout implements OnClickListener {
	...
	private static final int COLOR_SELECT = Color.WHITE; //Color.rgb(0x54, 0xdb, 0x4e);
	...
	private void init() {
		...
		mIndicators[0] = createIndicator(R.drawable.icon_add_white, R.string.booking_upcoming_tab, COLOR_SELECT, TAG_ICON_0, TAG_TEXT_0);
...
//		mIndicators[which].setBackgroundResource(R.drawable.indic_select);
		...
		switch(which) {
			...
			case 2:
				...
				currIcon.setImageResource(R.drawable.icon_me_white);
			...
			case 3:
				...
				currIcon.setImageResource(R.drawable.icon_more_white);
